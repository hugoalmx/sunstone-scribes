...
export function NoteEditor({ isOpen, onClose, note, onSave }: NoteEditorProps) {
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-2 sm:p-4">
    <div className="w-full max-w-3xl h-[95vh] sm:h-auto flex flex-col rounded-2xl bg-background shadow-lg border">
      ...
      {/* Conteúdo rolável */}
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4 overscroll-contain pb-24 sm:pb-6">
        ...
        <input
          ...
          placeholder="Título"
          className="w-full px-3 py-3 rounded-xl border bg-background text-base"
        />
        ...
        <div className="rounded-xl border overflow-hidden">
          <ReactQuill
            ...
            className="min-h-[240px] [&_.ql-container]:min-h-[200px] [&_.ql-toolbar]:bg-muted/30"
          />
        </div>
            ...
            {MOOD_OPTIONS.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full rounded-xl px-2 py-3 border text-xs flex flex-col items-center gap-1 transition",
                    active
        ...
        <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => setProgress(0)}>
                    Em aberto (0%)
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setProgress(25)}>
                    Iniciado (25%)
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setProgress(50)}>
                    Em progresso (50%)
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setProgress(75)}>
                    Ajustes finais (75%)
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setProgress(100)}>
                    Concluído (100%)
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
          ...
          <div className="relative">
            ...
            <div
              className={`absolute left-0 top-0 h-2 rounded-full transition-all ${progressColorClass(
                progress
              )}`}
      ...
      {/* Footer (fixo) */}
      <div className="sticky bottom-0 z-10 px-4 py-3 border-t bg-background">
